...
![테스트케이스](./images/다다익성_테스트케이스2.png)
...
| 김기종    |  항상 침착하고 차분하게 팀을 이끌어주시는 모습이 인상 깊었습니다. 저희 팀분들이 섬세하고 꼼꼼해서 하나하나 지나치지 않고 일을 진행해 나가는 스타일인데 이럴때마다 여러가지 의견을 종합하고 때로는 결단력 있게 진행해 나가는 모습을 보면서 배울 점이 많다고 느꼈습니다. 프로젝트 동안 책임감 있게 팀을 이끌어주셔서 감사합니다 !  |
...
| 김기종    |  다재다능이 이분께 어울리는 말인거 같습니다. 프로젝트 구현에서의 필요한 논리성, 일을 끌고 나가려는 수행력 모두 갖추고 계신거 같습니다. 회의를 하면서 의견을 제시하실때마다 논리정연한 언변들을 들으면서 항상 설득당하고 저를 이해시켜주신 기억들이 생각납니다. 덕분에 저희의 프로젝트가 원활하게 진행됐던거 같습니다. 감사합니다 ! |
...
| 김기종    | 평소에 밝은 에너지로 저희 팀의 분위기를 증진하는 역할을 해주시지만, 회의나 의견을 제시할때 되면 차분하고 논리적으로 의견을 제시하는 모습을 보면서 저희 팀의 많은 도움을 주셨다고 느꼈습니다. 하루는 크게 아프셨는데, 집에도 안 가시고 내색 한번 없이 책임감 있게 마무리하고 가시는 모습을 보고 깊은 감동을 받았습니다. 감사합니다! |
...
| 김기종    | 자칫 팀 프로젝트를 진행하면서 다수의 의견이 잘못된 방향으로 흘러 갈 수도 있는데 이런 상황에서 용기있게 목소리를 내주시고 매번 기발하고 논리적인 아이디어를 제시해주시는 모습이 인상 깊었습니다. 어떤 상황에서도 최선을 다하시는 모습을 옆에서 지켜보면서 저도 많이 배우게 되고 많은 노고에 그저 감사할 따름이었습니다. |
...
| 김기종    | 협업 프로젝트에서 중요하다고 생각하는 것은 남들을 배려하는 마음과 자신의 의견 피력이 적절히 이루어지게 하는 것이라고 생각하는데, 이를 완벽하게 수행하시는 분이 아현님이라고 생각합니다. 모든 의견에 경청해주시고 상대방을 배려해주시는 모습에 많이 배우게 된 거 같습니다 ! 프로젝트 하는 동안 감사하다는 표현을 자주하지 못했던거 같은데 너무 감사합니다 !  |
